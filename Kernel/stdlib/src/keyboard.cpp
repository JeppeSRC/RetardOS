...
void keyboard_set_leds(bool scroll_lock, bool num_lock, bool caps_lock) {
	...
	uint8 data = (scroll_lock ? 1 : 0) | (num_lock ? 2 : 0) | (caps_lock ? 4 : 0);
